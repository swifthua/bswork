...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-body">
    ...
    <div style="padding: 20px;">
    	<form action="findExpenseExamineMore.do" method="post" id="form" class="layui-form layui-form-pane1">
    	<div >
		  报销类型：
			    	...
			    	<tr>
			    		...
			    		<td>
		    				<c:if test="${userExist.yhzh eq 'admin' }">
	    						<c:if test="${expense.wczt.ztms eq '未审核' }">
	    							<a class="edit" href="toExpenseExamine.do?bxid=${expense.bxid }">审核 </a>
	    						</c:if>
		    				</c:if>
			  ...
			  <tbody>
			    <c:forEach items="${pb.list }" var="business">
			    	<tr>
			    		...
			    		<td>
			    			<c:if test="${userExist.yhzh eq 'admin' }">
	    						<c:if test="${business.wczt.ztms eq '未审核' }">
	    							<a class="edit" href="toBusinessExamine.do?ccid=${business.ccid  }">审核 </a>
	    						</c:if>
		    				</c:if>
