...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-body">
    ...
    <div style="padding-left: 20px;padding-top: 10px;">	当前位置:<span style="color: blue;">考勤管理/请休假信息查看</span></div>
    <div style="padding: 20px;">
    	<form class="layui-form layui-form-pane1" action="arrangeAdd.do" id="form">
    	  <div style="margin-left:495px;font-size: 20px;font-weight: bold;">请休假信息查看 </div>
   		  <table class="layui-table" >
   		  	...
   		  	<c:if test="${examine.shyj1 ne null }">
   		  		<tr>
