...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-body">
    ...
    <div style="padding: 20px;">
    	<form class="layui-form layui-form-pane1" action="userEdit.do" id="form">
    	  <input type="hidden" id="yhdm" name="yhdm" value="${user.yhdm }"/>
		  ...
		  <div class="layui-form-item">
		    ...
		    <div class="layui-input-block" style="width: 650px;">
		      <input type="text" name="phone" id="phone" autocomplete="off" class="layui-input" value="${user.phone }" >
		    </div>
		  </div>
		  <div class="layui-form-item">
		    <label class="layui-form-label">email</label>
		    <div class="layui-input-block" style="width: 650px;">
		      <input type="text" name="email" id="email" autocomplete="off" class="layui-input" value="${user.email }" >
		    </div>
		  </div>
		  <div class="layui-form-item">
		    <label class="layui-form-label">所在地</label>
		    <div class="layui-input-block" style="width: 650px;">
		      <input type="text" name="address" id="address" autocomplete="off" class="layui-input" value="${user.address }"  >
		    </div>
		  </div>
		  <div class="layui-form-item">
