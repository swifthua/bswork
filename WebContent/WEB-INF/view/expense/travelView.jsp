...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-body">
    ...
    <div style="padding-left: 20px;padding-top: 10px;">	当前位置:<span style="color: blue;">报销管理/差旅报销查看</span></div>
    <div style="padding: 20px;">
    	<form class="layui-form layui-form-pane1" action="travelAdd.do" id="form">
    	  <div style="margin-left:495px;font-size: 20px;font-weight: bold;">差旅报销查看 </div>
